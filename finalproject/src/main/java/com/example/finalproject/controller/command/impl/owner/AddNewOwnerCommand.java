...
public class AddNewOwnerCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        ...
        try {
            ...
            User userFieldsForNewOwner = new User(login, encryptedPassword, UserRole.OWNER, name, surname, phoneNumber);
            User created = (User) userService.insertNewEntity(userFieldsForNewOwner);
